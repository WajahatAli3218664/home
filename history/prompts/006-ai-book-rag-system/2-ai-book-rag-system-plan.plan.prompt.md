...
user: "user"
command: "/sp.plan"
labels: ["plan", "ai", "book", "rag", "multilingual", "architecture"]
...
files:
  ...
  - "/006-ai-book-rag-system/research.md"
  - "/006-ai-book-rag-system/data-model.md"
  - "/006-ai-book-rag-system/quickstart.md"
  - "/006-ai-book-rag-system/contracts/api-contract.md"
tests: []
---

# AI Book RAG System Plan
