# Textbook AI Assistant API Documentation

## Overview
This document describes the API endpoints for the Textbook AI Assistant service for the Physical AI & Humanoid Robotics textbook. The service enables users to ask questions about textbook content and receive accurate answers based solely on the information provided in the book, with proper citations.
...
## Rate Limiting
The API implements rate limiting to prevent abuse. The current limit is 30 requests per minute per IP address.
